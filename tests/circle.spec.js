...
describe("4 - Implemente os casos de teste para a função `circle`", () => {
  ...
  it("Verifica se o objeto retornado possui 3 propriedades", () => {
    const teste = Object.keys(circle(3));
    expect(teste.length).toBe(3);
  });
  ...
  it("Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2", () => {
    const teste = Object.values(circle(2));
    expect(teste[2]).toBe(12.56);
  });

  it("Teste se dentro do objeto retornado, a função retorna uma `key` com `value` igual à área correta para um círculo de raio 3", () => {
    const teste = Object.values(circle(3));
    expect(teste[1]).toBeCloseTo(28.26, 1);
  });

  it("Teste se a função retorna, em um objeto, os dados corretos de um círculo de raio 3", () => {
    const teste = { radius: 3, area: 28.259999999999998, circumference: 18.84 };
    expect(circle(3)).toEqual(teste);
  });
...
/* console.log tests/circle.spec.js:37
{ radius: 2, area: 12.56, circumference: 12.56 }

console.log tests/circle.spec.js:38
